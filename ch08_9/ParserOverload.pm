...
# code taken directly from HOP website - hop.perl.plover.com - all licensing rights from the author and publisher apply to this file
# Library based on chap09/arith25.pl

package ParserOverload;
our ($nothing, $End_of_Input);

use Exporter;
@EXPORT_OK = qw(lookfor L $End_of_Input $nothing T error handle_error
...
sub ParserOverload::L { @_ = [@_]; goto &lookfor }
